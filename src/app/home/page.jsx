...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen bg-gray-100">
      ...
      <section id="about" className="min-h-screen px-6 py-30">
        <h2 className="text-3xl font-bold text-gray-700">Nosotros</h2>
      </section>

      <section id="servicios" className="min-h-screen px-6 py-30">
        <h2 className="text-3xl font-bold text-gray-700">Servicios</h2>
      </section>

      <section id="galeria" className="min-h-screen px-6 py-30">
        <h2 className="text-3xl font-bold text-gray-700">Galería</h2>
      </section>

      <section id="contacto" className="min-h-screen px-6 py-30">
